...
###################
def create_volume():
    return IMPL.create_volume()

def print_volume():
    return IMPL.print_volume()

def create_user():
    return IMPL.create_user()

def print_user():
    return IMPL.print_user()

def storage_create(context, share_values, create_share_instance=True):
    """Create new share."""
    return IMPL.storage_create(context, 123)

def storage_get(context, storage_id):
    return IMPL.storage_get(context,"123")
